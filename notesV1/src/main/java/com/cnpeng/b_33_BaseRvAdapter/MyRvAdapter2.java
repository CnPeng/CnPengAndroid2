 ...
 * 其他：
 */
public class MyRvAdapter2 extends BaseRvAdapter {
    private Context      mContext;
    private List<String> mList;

    public MyRvAdapter2(Context context, RecyclerView recyclerView) {
    ...
    void onBindContentHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ContentHolder) {
            ...
            mBinding.tv.setBackgroundColor(mContext.getResources().getColor(R.color.abec06));
